...
A high-performance, virtualized data table built with React and TypeScript that handles 1M+ rows. This project demonstrates React patterns including component composition, optimization techniques, and generic/reusable architecture.
